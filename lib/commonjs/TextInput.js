...
const TextInput = /*#__PURE__*/_react.default.forwardRef((_ref, ref) => {
  ...
  const activeAnimation = (0, _react.useMemo)(() => new _reactNative.Animated.Value(active ? 1 : 0), [active]);
  (0, _react.useEffect)(() => {
    ...
    style: [theme.typography.subtitle1, {
      ...
      transform: [{
        ...
        translateX: activeAnimation.interpolate({
          inputRange: [0, 1],
          outputRange: [0, variant === 'standard' ? leadingNode ? -(leadingSize + 12) : 0 : leadingNode ? -(leadingSize + 24) : -16]
        })
      }]
    }]
  }, label))), /*#__PURE__*/_react.default.createElement(_reactNative.View, {
